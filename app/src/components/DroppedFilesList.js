...
export class DroppedFilesList extends React.Component {
    ...
    renderIcon = ( { index, file } ) => file.type.includes( 'image' ) ?
                        ...
                        subheader={
                            <ListSubheader component="div">
                                ...
                                { this.props.files.length > 1 &&
                                    <Badge className={classes.badge} badgeContent={ this.props.files.length } color="secondary"/>
                                }
                            </ListSubheader>
                        }
                    >
...
export default withTheme(
    withStyles( styles )( DroppedFilesList )
);
